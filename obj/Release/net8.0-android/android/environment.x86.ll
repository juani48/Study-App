...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 272814462, ; hash 0x1042d17e, from name: AppEstudio1.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 624464729, ; hash 0x25389359, from name: AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 62
	...
	%struct.DSOCacheEntry {
		i64 1666741955, ; hash 0x635876c3, from name: aot-AppEstudio1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 175
	...
	%struct.DSOCacheEntry {
		i64 1921938819, ; hash 0x728e7583, from name: aot-AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 2429340707, ; hash 0x90cccc23, from name: libaot-AppEstudio1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 3164510180, ; hash 0xbc9e97e4, from name: libaot-AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 368
