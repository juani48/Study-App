...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1181522771681469144, ; hash 0x10659cb36c1be2d8, from name: AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 29
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1711472764992143241, ; hash 0x17c05f69781cbf89, from name: libaot-AppEstudio1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	...
	%struct.DSOCacheEntry {
		i64 4299662691395138275, ; hash 0x3bab786fee9b72e3, from name: AppEstudio1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 7580125991920156572, ; hash 0x6932046dad1b3f9c, from name: aot-AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	...
	%struct.DSOCacheEntry {
		i64 17110224643402087190, ; hash 0xed73baa8c91dbb16, from name: aot-AppEstudio1.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
	...
	%struct.DSOCacheEntry {
		i64 17565556671072272296, ; hash 0xf3c564b9dd417fa8, from name: libaot-AppEstudio1
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppEstudio1.dll.so
		ptr null; void* handle (0x0)
	}, ; 452
...
@.env.3 = private unnamed_addr constant [37 x i8] c"a505dccb-d7bb-43e8-91e3-9a8f69244d9e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.appestudio1\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-AppEstudio1.dll.so\00", align 16
